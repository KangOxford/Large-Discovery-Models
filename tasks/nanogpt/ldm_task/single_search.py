...
from tasks.nanogpt.ldm_task.search_core import DEFAULT_TASK_CONTEXT, SearchConfig, SearchEngine


METHODS = {
    "best_of_n": "tasks.nanogpt.ldm_task.search_methods.best_of_n",
    "beam": "tasks.nanogpt.ldm_task.search_methods.beam_search",
    "beam_search": "tasks.nanogpt.ldm_task.search_methods.beam_search",
    "mcts": "tasks.nanogpt.ldm_task.search_methods.mcts",
    "tree": "tasks.nanogpt.ldm_task.search_methods.tree_search",
    "tree_search": "tasks.nanogpt.ldm_task.search_methods.tree_search",
}
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument(
        "--llm-url",
        default=os.environ.get("TTS_LLM_URL", "http://10.253.9.4:52306/v1"),
        help="OpenAI-compatible base URL. For closed_loop, set TTS_LLM_URL or pass the LiteLLM URL.",
    )
    parser.add_argument("--llm-model-name", default=os.environ.get("TTS_LLM_MODEL", "Qwen2.5-7B"))
