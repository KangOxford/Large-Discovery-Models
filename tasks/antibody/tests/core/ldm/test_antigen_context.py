...
from tasks.antibody.core.ldm.antigen_context import (
...
def test_absolut_info_returns_process_output(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr("tasks.antibody.core.ldm.antigen_context.subprocess.run", fake_run)
...
def test_collect_antigen_context_combines_commands_and_raw_output(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr(
        "tasks.antibody.core.ldm.antigen_context.run_absolut_info",
