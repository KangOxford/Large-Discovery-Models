# AI4Bio Mutation Effect Prediction Resources

`upstream_contract.json` pins the MLS-Bench source commit, task path, critical
task and scorer file digests, ESM-2 embedding dimension, and exact parameter
