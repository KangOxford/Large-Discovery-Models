...
if not round2_highlight_x.empty:
...
if not round3_highlight_x.empty:
...
if not round4_highlight_x.empty:
...
ax.annotate("Searched: batch100 warmdown 0.45625 adam 0.625", (idx-150, bpb),
            textcoords="offset points",
            xytext=(6, 6), fontsize=8.0,
            color="#1a7a3a", alpha=0.9,
            rotation=30, ha="left", va="bottom")
...
plt.tight_layout()
plt.savefig("progress.pdf", dpi=150, bbox_inches="tight")
plt.show()
