...
async def openai_compatible_generate(
        ...
        temperature=0.,
        stop=None,
        llm_url="https://litellm.yangtzeailab.com/v1",
        llm_model_name="Qwen3-VL-235B-A22B-Instruct-FP8",
...
async def tool_call_generate(
        ...
        temperature=0.,
        stop=None,
        llm_url="http://127.0.0.1:52307/v1",
        llm_model_name="Qwen3-Coder-30B-A3B-Instruct",
        disable_thinking=False,
        api_key=None,
        logprobs=False,
        top_logprobs=None,
...
async def vllm_generate(
        ...
        temperature=0., 
        stop=None, 
        llm_url="http://10.253.9.4:52306/v1", 
