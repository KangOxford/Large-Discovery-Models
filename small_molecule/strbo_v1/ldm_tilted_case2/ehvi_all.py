"""Finite-candidate EHVI adapter for case2 tilted selection."""
...
from strbo_v1.acquisition import expected_hypervolume_improvement, pareto_front
...
def _compute_ehvi(
    ...
    return np.clip(np.asarray(ehvi, dtype=float).ravel(), 0.0, None)
