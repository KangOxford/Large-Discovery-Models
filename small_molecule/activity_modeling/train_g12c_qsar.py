...
def parse_args(argv: Optional[list[str]] = None) -> argparse.Namespace:
    ...
    parser.add_argument("--output-dir", default="", help="Run output directory. Defaults to activity_modeling/runs/g12c_<timestamp>.")
    parser.add_argument("--cache-dir", default="activity_modeling/cache", help="ChEMBL API cache directory.")
    ...
    parser.add_argument("--optuna-storage", default="", help="Optional Optuna storage URL, e.g. sqlite:///activity_modeling/cache/optuna.db.")
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    output_dir = Path(args.output_dir) if args.output_dir else script_dir / "runs" / f"{args.mutation.lower()}_{now_stamp()}"
