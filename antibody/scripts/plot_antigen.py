...
PREFERRED_STYLES = {
    "BO+LLM": {"linestyle": "-", "linewidth": 3.0, "zorder": 5},
    "LLM baseline": {"linestyle": "--", "linewidth": 2.3, "zorder": 4},
    "BO_transformed_overlap": {"linestyle": "-", "linewidth": 2.2, "zorder": 3},
}
STYLE_CYCLE = [
...
def method_label(method: str) -> str:
    return method.removeprefix("paper:")
...
def method_matches(method: str, names: set[str]) -> bool:
    ...
    return method in names or label in names
